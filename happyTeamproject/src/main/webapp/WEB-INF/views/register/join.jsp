...
<div class="container">
	...
	<form method="post" id="joinForm">
		<ul>
			<li>아이디</li>
			<li>
				<input type="text" name="userid" id="userid" minlength="8" maxlength="15" value="abcdefg"/>
			...
			<li>
				...
				<input type="checkbox" name="hobbyArr" value="바이크"/>바이크
				...
				<input type="checkbox" name="hobbyArr" value="걷기"/>걷기
				<input type="checkbox" name="hobbyArr" value="영화감상"/>영화감상
			</li>
			<li>
